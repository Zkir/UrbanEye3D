...
public class ColorUtils {
    ...
    static {
        // Based on https://github.com/Zkir/VFR_LANDMARKS_3D_RU/blob/master/OsmParser/mdlMisc.py
        ...
        COLOR_MAP.put("lightbrown", new Color(150, 111, 51));
        COLOR_MAP.put("brick", new Color(142, 35, 35));
        COLOR_MAP.put("concrete", new Color(128, 128, 102));
    }
    ...
    public static Color parseColor(String colorStr) {
        ...
        Color color = COLOR_MAP.get(colorStr.toLowerCase());
        if (color != null) {
            return color;
        }

        // If not found by name, try to decode as a hex string
        try {
            return Color.decode(colorStr);
        } catch (NumberFormatException e) {
            // Not a valid hex string, return null
            return null;
        }
    }
}
